...
public class SegmentAssignmentStrategyTestUtils {
  private SegmentAssignmentStrategyTestUtils() {
  }
  ...
  /**
   * Returns a map form instance name to the state associated with it.
   */
