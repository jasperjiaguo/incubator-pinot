...
public class SegmentAssignmentStrategyFactory {
  ...
  public static SegmentAssignmentStrategy getSegmentAssignmentStrategy(ZkHelixPropertyStore<ZNRecord> propertyStore,
      TableConfig tableConfig) {
    SegmentAssignmentStrategy segmentAssignmentStrategy;
    if (tableConfig.getTableType() == TableType.OFFLINE) {
      if (ReplicaGroupSegmentAssignmentStrategy.class.getName()
    ...
    segmentAssignmentStrategy.init(propertyStore, tableConfig);
