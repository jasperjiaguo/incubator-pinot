...
class ReplicaGroupJumpHashSegmentAssignmentStrategy implements SegmentAssignmentStrategy {
  private static final Logger LOGGER = LoggerFactory.getLogger(ReplicaGroupJumpHashSegmentAssignmentStrategy.class);
